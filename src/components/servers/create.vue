                            ...
                            <div class="content">
                                <div class="columns">
                                    ...
                                    <b-field label="Tag" label-position='' class="column">
                                        <b-input disabled v-model="newServer.tag" placeholder="tagx"></b-input>
                                    </b-field>
                                ...
                                <b-field label="Description"  label-position=''>
                                    <b-input disabled type="textarea" v-model="newServer.description" placeholder="Insert a description for the new server" value=""></b-input>
                                </b-field>
                    ...
                    <b-collapse
                        ...
                        <div class="card-content">
                            ...
                            <div v-if="chooseNetwork=='manual'" class="columns">
                                ...
                                <b-field label="Access IPv6" label-position='' class="column">
    ...
    methods: {
        ...
        createServer(){
            ...
            if(!this.selectedFlavor){
                this.error("Invalid - Select Flavor");
                this.loading = false
                return;
            }

            if(!this.selectedNetworks.length>0){
                this.error("Invalid - Select at least one Network");
                this.loading = false
                return;
            }
            ...
            if(this.chooseNetwork=="auto"){
                this.error("Auto network not available");
                this.loading = false
                return;
            }
